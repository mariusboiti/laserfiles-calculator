...
function ToolShellInner({
  ...
  const emptyStatePrimaryAction = toolUxState.primaryAction ?? (tourAvailable ? { label: 'Start tour', onClick: startTour } : undefined);
  const emptyStateSecondaryAction = toolUxState.secondaryAction ?? (tutorialAvailable ? { label: 'Tutorial', onClick: handleOpenTutorial } : help ? { label: 'Help', onClick: () => setHelpOpen(true) } : undefined);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <button
                ...
                title={toolUxState.onUndo && toolUxState.canUndo !== false ? 'Undo last action' : 'Undo is not available'}
              >
              ...
              <div className="mt-1 text-right text-[11px] text-slate-500">
                Laser-ready vector output · Review before cutting
              </div>
          ...
          <div className="mt-3 rounded-lg border border-slate-800 bg-slate-950 p-3">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div className="text-xs text-slate-200">
                We found a recent session for this tool.
              </div>
              <div className="flex items-center gap-2">
                <button
                  type="button"
      ...
      {resetConfirmOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-[min(520px,calc(100vw-2rem))] rounded-xl border border-slate-800 bg-slate-950 p-5 text-slate-100 shadow-xl">
            <div className="text-lg font-semibold">Reset tool?</div>
            <div className="mt-2 text-sm text-slate-300">This will clear your current work for this tool.</div>
