...
export class TemplatesService {
  ...
  async update(id: string, input: UpdateTemplateInput) {
    ...
    return this.prisma.productTemplate.update({
      ...
      data: {
        ...
        baseWidthMm:
          typeof input.baseWidthMm !== 'undefined'
            ? input.baseWidthMm
            : existing.baseWidthMm,
        baseHeightMm:
          typeof input.baseHeightMm !== 'undefined'
            ? input.baseHeightMm
            : existing.baseHeightMm,
        layersCount:
          typeof input.layersCount !== 'undefined'
            ? input.layersCount
      ...
      for (const field of template.fields) {
        await tx.templatePersonalizationField.create({
          data: {
            ...
            optionsJson: field.optionsJson as any,
      ...
      for (const rule of template.pricingRules) {
        await tx.templatePricingRule.create({
          data: {
            ...
            value: rule.value,
            appliesWhenJson: rule.appliesWhenJson as any,
  ...
  async listVariants(templateId: string) {
  ...
  async createVariant(templateId: string, input: CreateVariantInput) {
    await this.ensureTemplateExists(templateId);
  ...
  async updateVariant(templateId: string, variantId: string, input: UpdateVariantInput) {
    ...
    return this.prisma.templateVariant.update({
      ...
      data: {
        ...
        widthMm:
          typeof input.widthMm !== 'undefined' ? input.widthMm : variant.widthMm,
        heightMm:
          typeof input.heightMm !== 'undefined' ? input.heightMm : variant.heightMm,
        isActive:
          typeof input.isActive !== 'undefined' ? input.isActive : variant.isActive,
      },
    });
  }
  ...
  async createField(templateId: string, input: CreateFieldInput) {
    await this.ensureTemplateExists(templateId);
  ...
  async updateField(templateId: string, fieldId: string, input: UpdateFieldInput) {
    ...
    return this.prisma.templatePersonalizationField.update({
      ...
      data: {
        ...
        required:
          typeof input.required !== 'undefined' ? input.required : field.required,
        minNumber:
          typeof input.minNumber !== 'undefined' ? input.minNumber : field.minNumber,
        maxNumber:
          typeof input.maxNumber !== 'undefined' ? input.maxNumber : field.maxNumber,
        maxLength:
          typeof input.maxLength !== 'undefined' ? input.maxLength : field.maxLength,
        optionsJson:
          typeof input.optionsJson !== 'undefined'
            ? input.optionsJson
            : field.optionsJson,
        affectsPricing:
          typeof input.affectsPricing !== 'undefined'
            ? input.affectsPricing
            : field.affectsPricing,
        affectsProductionNotes:
          typeof input.affectsProductionNotes !== 'undefined'
  ...
  async listPricingRules(templateId: string) {
    await this.ensureTemplateExists(templateId);
  ...
  async createPricingRule(templateId: string, input: CreatePricingRuleInput) {
    await this.ensureTemplateExists(templateId);
  ...
  async updatePricingRule(
    ...
    if (!rule || rule.templateId !== templateId) {
      throw new NotFoundException('Template pricing rule not found');
    }
    ...
    return this.prisma.templatePricingRule.update({
      ...
      data: {
        ...
        variantId:
          typeof input.variantId !== 'undefined' ? input.variantId : rule.variantId,
        appliesWhenJson:
          typeof input.appliesWhenJson !== 'undefined'
            ? input.appliesWhenJson
            : rule.appliesWhenJson,
        priority:
          typeof input.priority !== 'undefined' ? input.priority : rule.priority,
      },
    });
  }
